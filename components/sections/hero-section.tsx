...
export default function HeroSection({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="container relative mx-10 z-10 py-16 sm:py-20 md:py-24 lg:py-36">
        <div className="max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl space-y-4 sm:space-y-6 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2 sm:pt-4">
            <Button
              ...
              rounded="full"
              size="lg"
              className="gap-2 px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base group w-full sm:w-auto"
            >
              Pesan Sekarang
            ...
            <Button
              ...
              rounded="full"
              size="lg"
              className="bg-white/10 backdrop-blur-sm text-white border-white/20 hover:bg-white/20 px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base w-full sm:w-auto"
      ...
      {/* Scroll Down Indicator - Hidden on small screens */}
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-white animate-bounce hidden sm:flex">
